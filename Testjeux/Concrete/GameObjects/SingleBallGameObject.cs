...
namespace GameNameSpace
{
	public sealed class SingleBallGameObject : BaseBallGameObject
	{
			...
			: base(Services.Instance.Get<IAssetService>().GetTexture(TextureName.RedBullet), position, speed, size)
		{
			...
			TrailParticlesEmitter = new BallTrailParticlesEmitter(this, Services.Instance.Get<IShapeService>().CropTexture(Texture, new Rectangle(new Point(224, 0), new Point(32))), 1.0f, 2.5f);
		}
	}
}