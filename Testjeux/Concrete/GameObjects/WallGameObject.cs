...
namespace GameNameSpace
{
	public class WallGameObject : BaseGameObject
	{
			...
			: base()
		{
			...
			Texture2D texture = Services.Instance.Get<IShapeService>().CropTexture(Services.Instance.Get<IAssetService>().GetTexture(TextureName.Cube), new Rectangle(new Point(textureIndex * 64, 0), new Point(64)));
